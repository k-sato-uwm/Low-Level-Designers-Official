...
class DashboardTests(TestCase):
    def setup(self):
        ...
        inst.save()
        admin = User(username='TestAdmin', password='pass123', role='Administrator')
        admin.save()

    def test_signedinAdmin(self): # If the user signs in as an Admin
        ...
        self.assertEqual(self.client.session['role'], 'Administrator')
