...
from scheduler.views import UserManagementView, LoginView, Dashboard, CourseManagement, CourseEditView, userAll, MyInfo
...
urlpatterns = [
    ...
    path('profile/', MyInfo.as_view(), name='profile'),
